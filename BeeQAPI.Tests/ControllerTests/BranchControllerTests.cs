...
//    {
//        private readonly Mock<IBAL_Branch> _balMock;
//        private readonly BranchController _controller;

//        public BranchControllerTests()
//        {
//            _balMock = new Mock<IBAL_Branch>();
//            _controller = new BranchController(_balMock.Object);
//        }
...
//        [Fact]
//        public async Task GetAll_Should_Return_Branch_List_Successfully()
//        {
//            // Arrange
...
//            var expectedResponse = new APIGetResponseModel<List<BranchModel>>
//            {
//                IsSuccess = true,
...
//        [Fact]
//        public async Task GetById_Should_Return_Branch_By_Id()
//        {
//            // Arrange
//            long id = 1;
//            var roles = new List<string> { "Super Admin" };
...
//            var expectedResponse = new APIGetResponseModel<BranchModel>
//            {
//                IsSuccess = true,
...
//        {
//            // Arrange
//            var request = new BranchStatusRequestDto
//            {
//                BranchId = 10
//            };
...
//            _balMock
//                .Setup(x => x.ChangeStatus(request.BranchId, roles, email, null))
//                .ReturnsAsync(expectedResponse);
...
//            _balMock
//                .Setup(x => x.ChangeStatus(request.BranchId, It.Is<List<string>>(r => r.Count == 0), email, null))
//                .ReturnsAsync(expectedResponse);
