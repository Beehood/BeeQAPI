...
{
    public class BranchServiceControllerTests
    {
        private readonly Mock<IBAL_BranchService> _balMock;
        private readonly BranchServiceController _controller;

        public BranchServiceControllerTests()
        {
            _balMock = new Mock<IBAL_BranchService>();
            _controller = new BranchServiceController(_balMock.Object);
        }
        ...
        // =========================================================
        [Fact]
        public async Task GetAll_Should_Return_BranchService_List_Successfully()
        {
            // Arrange
            ...
            var expectedResponse = new APIGetResponseModel<List<BranchServiceModel>>
            {
                IsSuccess = true,
                Result = new List<BranchServiceModel>
                {
                    new BranchServiceModel(),
                    new BranchServiceModel()
                }
            };
        ...
        // =========================================================
        [Fact]
        public async Task GetById_Should_Return_BranchService_By_Id()
        {
            // Arrange
            long id = 1;
            var roles = new List<string> { "Super Admin" };
            ...
            var expectedResponse = new APIGetResponseModel<BranchServiceModel>
            {
                IsSuccess = true,
        ...
        {
            // Arrange
            var request = new BranchServiceRequestDto();
            var roles = new List<string> { "Super Admin" };
            var email = "test@mail.com";
        ...
        {
            // Arrange
            var request = new BranchServiceStatusRequestDto
            {
                BranchServiceId = 10
            };
            ...
            _balMock
                .Setup(x => x.ChangeStatus(request.BranchServiceId, roles, email, null))
                .ReturnsAsync(expectedResponse);
        ...
        public async Task ChangeStatus_Should_Pass_Empty_Roles_When_No_Role_Claims()
        {
            ...
            _balMock
                .Setup(x => x.ChangeStatus(request.BranchServiceId, It.Is<List<string>>(r => r.Count == 0), email, null))
                .ReturnsAsync(expectedResponse);
        ...
        // =========================================================
        [Fact]
        public async Task GetBranchDropdownByOrganization_Should_Return_Dropdown_List_Successfully()
        {
            // Arrange
            long orgId = 1;
            var email = "test@mail.com";
            ...
            _balMock
                .Setup(x => x.GetBranchDropdownByOrganization(orgId, email, null))
                .ReturnsAsync(expectedResponse);

            // Act
            var result = await _controller.GetBranchDropdownByOrganization(orgId);
        ...
        [Fact]
        public async Task GetBranchDropdownByOrganization_Should_Pass_Null_Email_When_Claim_Missing()
        {
            // Arrange
            long orgId = 1;
            SetUserClaims(new List<string> { "Super Admin" }, null);
            ...
            _balMock
                .Setup(x => x.GetBranchDropdownByOrganization(orgId, null, null))
                .ReturnsAsync(expectedResponse);
