...
namespace BeeQAPI.Tests.Controllers
{
    ...
    {
        private readonly Mock<IBAL_Service> _balMock;
        private readonly ServiceController _controller;

    public ServiceControllerTests()
        {
            _balMock = new Mock<IBAL_Service>();
            _controller = new ServiceController(_balMock.Object);
        }
        ...
        // ========================
        [Fact]
        public async Task GetAll_Should_Return_Service_List()
        {
            // Arrange
            ...
            var expectedResponse = new APIGetResponseModel<List<ServiceModel>>
            {
                IsSuccess = true,
        ...
        // ========================
        [Fact]
        public async Task GetById_Should_Return_Service_By_Id()
        {
            // Arrange
            long id = 1;
            var roles = new List<string> { "Super Admin" };
            ...
            var expectedResponse = new APIGetResponseModel<ServiceModel>
            {
                IsSuccess = true,
        ...
        {
            // Arrange
            var request = new ServiceStatusRequestDto
            {
                ServiceId = 1
            };
            ...
            _balMock
                .Setup(x => x.ChangeStatus(request.ServiceId, roles, email, null))
                .ReturnsAsync(expectedResponse);
            ...
            _balMock.Verify(x => x.ChangeStatus(request.ServiceId, roles, email, null), Times.Once);
        }
