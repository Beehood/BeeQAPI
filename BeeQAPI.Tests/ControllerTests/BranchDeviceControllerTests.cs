...
{
    public class BranchDeviceControllerTests
    {
        private readonly Mock<IBAL_BranchDevice> _balMock;
        private readonly BranchDeviceController _controller;

        public BranchDeviceControllerTests()
        {
            _balMock = new Mock<IBAL_BranchDevice>();
            _controller = new BranchDeviceController(_balMock.Object);
        }
        ...
        // =========================================================
        [Fact]
        public async Task GetAll_Should_Return_Device_List_Successfully()
        {
            // Arrange
            ...
            var expectedResponse = new APIGetResponseModel<List<DeviceModel>>
            {
                IsSuccess = true,
        ...
        // =========================================================
        [Fact]
        public async Task GetById_Should_Return_Device_By_Id()
        {
            // Arrange
            long id = 1;
            var roles = new List<string> { "Super Admin" };
            ...
            var expectedResponse = new APIGetResponseModel<DeviceModel>
            {
                IsSuccess = true,
        ...
        {
            // Arrange
            var request = new DeviceStatusRequestDto
            {
                DeviceId = 10
            };
            ...
            _balMock
                .Setup(x => x.ChangeStatus(request.DeviceId, roles, email, null))
                .ReturnsAsync(expectedResponse);
        ...
        public async Task ChangeStatus_Should_Pass_Empty_Roles_When_No_Role_Claims()
        {
            ...
            _balMock
                .Setup(x => x.ChangeStatus(request.DeviceId, It.Is<List<string>>(r => r.Count == 0), email, null))
                .ReturnsAsync(expectedResponse);
