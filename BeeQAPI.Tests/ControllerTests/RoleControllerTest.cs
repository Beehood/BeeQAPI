...
//    {
//        private readonly Mock<IBAL_Role> _balMock;
//        private readonly RoleController _controller;

//    public RoleControllerTests()
//        {
//            _balMock = new Mock<IBAL_Role>();
//            _controller = new RoleController(_balMock.Object);
//        }
...
//        // ========================
//        [Fact]
//        public async Task GetAll_Should_Return_Role_List()
//        {
//            // Arrange
...
//            var expectedResponse = new APIGetResponseModel<List<RoleModel>>
//            {
//                IsSuccess = true,
...
//        // ========================
//        [Fact]
//        public async Task GetById_Should_Return_Role_By_Id()
//        {
//            // Arrange
//            long id = 1;
//            var roles = new List<string> { "Super Admin" };
...
//            var expectedResponse = new APIGetResponseModel<RoleModel>
//            {
//                IsSuccess = true,
...
//        // ========================
//        [Fact]
//        public async Task ChangeStatus_Should_Return_Success_When_RoleId_Is_Valid()
//        {
//            // Arrange
//            var request = new RoleStatusRequestDto
//            {
//                RoleId = 1
//            };
...
//            _balMock
//                .Setup(x => x.ChangeStatus(request.RoleId, roles, email, null))
//                .ReturnsAsync(expectedResponse);
...
//            _balMock.Verify(x => x.ChangeStatus(request.RoleId, roles, email, null), Times.Once);
//        }
...
//        // ========================
//        [Fact]
//        public async Task GetDropdown_Should_Return_Role_Dropdown_List()
//        {
//            // Arrange
//            var email = "admin@test.com";
...
//        [Fact]
//        public async Task GetDropdown_Should_Pass_Null_Email_When_NameIdentifier_Not_Present()
//        {
//            // Arrange
//            var claims = new List<Claim>
//        {
...
//            _balMock.Verify(x => x.GetDropdown(null, null), Times.Once);
//        }
//    }
