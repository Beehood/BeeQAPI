...
namespace BeeQAPI.Tests
{
    ...
    {
        private readonly Mock<IBAL_Organization> _balMock;
        private readonly OrganizationController _controller;

        public OrganizationControllerTests()
        {
            _balMock = new Mock<IBAL_Organization>();
            _controller = new OrganizationController(_balMock.Object);
        }
        ...
        // ========================
        [Fact]
        public async Task GetAll_Should_Return_Organization_List()
        {
            // Arrange
            ...
            var expectedResponse = new APIGetResponseModel<List<OrganizationModel>>
            {
                IsSuccess = true,
        ...
        // ========================
        [Fact]
        public async Task GetById_Should_Return_Organization_By_Id()
        {
            // Arrange
            long id = 1;
            var roles = new List<string> { "Super Admin" };
            ...
            var expectedResponse = new APIGetResponseModel<OrganizationModel>
            {
                IsSuccess = true,
        ...
        public async Task Update_Should_Return_Success_When_Request_Is_Valid()
        {
            ...
            {
                OrganizationId = 1,
                Name = "Beehood Updated",
                Email = "orgupdated@mail.com",
                Phone = "9999999999"
            };
        ...
        // ========================
        [Fact]
        public async Task ChangeStatus_Should_Return_Success_When_OrganizationId_Is_Valid()
        {
            // Arrange
            var request = new OrganizationStatusRequestDto
            {
                OrganizationId = 1
            };
            ...
            _balMock
                .Setup(x => x.ChangeStatus(request.OrganizationId, roles, email, null))
                .ReturnsAsync(expectedResponse);
            ...
            _balMock.Verify(x => x.ChangeStatus(request.OrganizationId, roles, email, null), Times.Once);
        }
        ...
        // ========================
        [Fact]
        public async Task GetDropdown_Should_Return_Organization_Dropdown()
        {
            // Arrange
            var email = "admin@mail.com";
